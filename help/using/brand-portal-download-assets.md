...
# Brand Portalからのアセットのダウンロード {#download-assets-from-bp}
...
Brand Portalの管理者は、Brand Portalユーザーに対してアセットのダウンロード設定と権限を設定できます。この権限を持つユーザーは、Brand Portalインターフェイスからアセットのレンディションにアクセスしてダウンロードできます。

Brand Portalからレンディションにアクセスしてダウンロードする方法は、次の設定で定義されます。
...
管理者は、アセットの **[!UICONTROL ダウンロード設定を有効にして]** 、Brand Portalユーザがダウンロードできるレンディションのセットを定義できます。
...
### ダウンロード権限の設定 {#configure-download-permissions}

Brand Portal管理者は、 **[!UICONTROL ダウンロード設定に加えて]**、様々なグループのユーザーに対して表示権限を設定したり、元のアセットとそのレンディションをダウンロード（またはダウンロード）したりできます。

Log in to your Brand Portal tenant as an administrator and navigate to **[!UICONTROL Tools]** > **[!UICONTROL Users]**. ユー **[!UICONTROL ザーの役割]** ページで、「 **[!UICONTROL グループ]** 」タブに移動して、ユーザーを設定し、表示グループの（または）ダウンロード権限を設定します。
...
次の表は、 [ダウンロードの設定に応じて、ユーザーがレンディションにアクセスできるかどうかを定義しています](#configure-download)。

| **ダウンロード設定：カスタムレンディション** | **ダウンロード設定：システムレンディション** | **ユーザーグループの権限：オリジナルをダウンロード** | **ユーザーグループの権限：レンディションをダウンロード** | **結果** |
|---|---|---|---|---|
| オン | オン | オン | オン | すべてのレンディションを表示してダウンロードする |
| オン | オン | OFF | OFF | 表示の元のアセット |
| OFF | OFF | オン | オン | 元のアセットの表示とダウンロード |
| オン | OFF | オン | オン | 元のアセットとカスタムレンディションの表示とダウンロード |
| OFF | オン | オン | オン | 元のアセットとシステムレンディションの表示とダウンロード |
| オン | OFF | OFF | OFF | 表示の元のアセット |
| OFF | オン | OFF | OFF | 表示の元のアセット |
| OFF | OFF | OFF | オン | 表示の元のアセット |
| OFF | OFF | オン | OFF | 元のアセットの表示とダウンロード |
| OFF | OFF | OFF | OFF | 表示の元のアセット |
...
>[!NOTE]
>
>レンディションにアクセスまたはダウンロードする権限がない場合は、Brand Portal管理者に問い合わせてください。

ユーザーがレンディションにアクセスできる場合、次の機能を備えた拡張 **[!UICONTROL ダウンロード]** ダイアログが提供されます。
...
>[!NOTE]
>
>**[!UICONTROL ダウンロード]** ダイアログは、アセットをダウンロード用に選択し、ダウンロード設定ディションで **[!UICONTROL カスタムレンディション]** または **[!UICONTROL システムレンディションが有効な場合にのみ表示され]******&#x200B;ます。
...
1. 選択したすべてのアセットが **[!UICONTROL ダウンロード]** ダイアログに表示されます。
   ...
   また、（必要に応じて）削除 **** アイコンをクリックして、ダウンロードリストからアセットを削除することもできます。
   ...
   ダウンロードボタンは、選択した項目の数を反映します。 ルールの適用が完了したら、「項目を **[!UICONTROL ダウンロード]**」をクリックします。

   ![download-dialog](assets/download-dialog-new.png)

1. By default the **[!UICONTROL Fast Download]** setting is enabled in the **[!UICONTROL Download Settings]**. したがって、IBM Aspera Connectを使用した高速ダウンロードを許可する確認ボックスが表示されます。

   「 **[!UICONTROL 高速ダウンロード]**」を引き続き使用するには、「 **[!UICONTROL 許可]**」をクリックします。 選択したすべてのレンディションが、IBM Aspera Connectを使用してzipフォルダーにダウンロードされます。
...
>[!NOTE]
>
>20個を超えるアセットをダウンロード用に選択した場合、 **[!UICONTROL ダウンロード]** ダイアログはスキップされ、動的レンディションを除くユーザがアクセスできるすべてのレンディションが直接zipフォルダーにダウンロードされます。
>
>アセットとコレクションを含むフォルダーのダウンロード時も、同じ動作が行われます。 動的レンディションを除くアクセス可能なレンディションは、zipフォルダーに直接ダウンロードされます。
...
ユーザーは、 **[!UICONTROL ダウンロード]** ダイアログを開かずに、様々なレンディションをプレビューしたり、特定のレンディションを選択したり、アセットの詳細ページのレンディション **** パネルから直接ダウンロードしたりできます。
...
1. 「 **[!UICONTROL レンディション]** 」パネルには、アセットの [ダウンロード設定に基づいて、アクセス可能なすべてのアセットレンディションがリストされます](#configure-download)。

   ダウンロードする特定のレンディションを選択し、「項目を **[!UICONTROL ダウンロード]**」をクリックします。
