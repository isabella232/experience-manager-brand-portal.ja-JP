...
3. 以下を指定します。
   ...
   * [!UICONTROL 地域]これらの値がAEM作成者インスタンスの値と同じであることを確認します。
